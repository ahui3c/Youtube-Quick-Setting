...
const MESSAGES = {
  "zh-Hant": {
    ...
    shortcutTitle: "播放時快速操作", shortcutDescription: "−／+ 調速，* 回復 1×，S 複製，Shift+S 時間點",
    shortsShortcutTitle: "Shorts 快速操作", shortsShortcutDescription: "←／→ {seconds} 秒，0 片頭；−／+ 調速，* 1×，S 複製，Shift+S 時間點",
    copyVideoInfoTitle: "複製影片資訊", copyVideoInfoDescription: "預設：{format}｜S；Shift+S 複製時間點", copiedVideoInfo: "已複製到剪貼簿", copyVideoInfoFailed: "複製失敗", copyVideoInfoUnavailable: "請先開啟 YouTube 影片", copyFormatToggle: "選擇複製格式",
    copyFormatTitleUrl: "標題＋網址", copyFormatTimestampUrl: "目前時間點網址", copyFormatMarkdown: "Markdown 連結", copyFormatHtml: "HTML 超連結", copyFormatUrlOnly: "僅複製網址", copyFormatTitleOnly: "僅複製標題", copyFormatChannelTitleUrl: "頻道＋標題＋網址",
  ...
  en: {
    ...
    shortcutTitle: "Quick playback controls", shortcutDescription: "−/+ speed, * resets, S copies, Shift+S copies timestamp",
    shortsShortcutTitle: "Shorts quick controls", shortsShortcutDescription: "←/→ {seconds}s, 0 restarts; −/+ speed, * 1×, S copies, Shift+S timestamp",
    copyVideoInfoTitle: "Copy video info", copyVideoInfoDescription: "Default: {format} | S; Shift+S copies timestamp", copiedVideoInfo: "Copied to clipboard", copyVideoInfoFailed: "Copy failed", copyVideoInfoUnavailable: "Open a YouTube video first", copyFormatToggle: "Choose copy format",
    copyFormatTitleUrl: "Title + URL", copyFormatTimestampUrl: "URL at current time", copyFormatMarkdown: "Markdown link", copyFormatHtml: "HTML link", copyFormatUrlOnly: "URL only", copyFormatTitleOnly: "Title only", copyFormatChannelTitleUrl: "Channel + title + URL",
  ...
  ja: {
    ...
    shortcutTitle: "再生中のクイック操作", shortcutDescription: "−／+ 速度、* で 1×、S コピー、Shift+S 現在位置",
    shortsShortcutTitle: "ショートのクイック操作", shortsShortcutDescription: "←／→ {seconds} 秒、0 先頭、−／+ 速度、* 1×、S コピー、Shift+S 現在位置",
    copyVideoInfoTitle: "動画情報をコピー", copyVideoInfoDescription: "既定：{format}｜S、Shift+S は現在位置", copiedVideoInfo: "クリップボードにコピーしました", copyVideoInfoFailed: "コピーに失敗しました", copyVideoInfoUnavailable: "YouTube 動画を開いてください", copyFormatToggle: "コピー形式を選択",
    copyFormatTitleUrl: "タイトル＋URL", copyFormatTimestampUrl: "現在位置の URL", copyFormatMarkdown: "Markdown リンク", copyFormatHtml: "HTML リンク", copyFormatUrlOnly: "URL のみ", copyFormatTitleOnly: "タイトルのみ", copyFormatChannelTitleUrl: "チャンネル＋タイトル＋URL",
...
function copyFormatLabel(format) {
  const keys = {
    ...
    html: "copyFormatHtml",
    "url-only": "copyFormatUrlOnly",
    "title-only": "copyFormatTitleOnly",
