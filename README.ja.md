...
- Premium 登録済みと明確に確認できる場合のみ高ビットレート 1080p を優先
- 通常動画とショートを個別に設定
...
`1080p Premium` は、YouTube Premium 登録済みと明確に確認でき、対象動画にも項目がある場合のみ自動選択します。未登録または資格を確認できない場合は標準画質を使用し、Premium の体験案内を表示させません。
